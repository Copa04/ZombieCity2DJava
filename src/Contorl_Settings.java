...
public class Contorl_Settings extends back_ground_image {
    ...
    public Contorl_Settings() {
        ...
        Label_extend title = new Label_extend("Control Settings");
    ...
    // Etichetă + Buton pentru right_key
        ...
        rightKeyLabel.setBounds(ct.button_change_label_x_offset, ct.button_change_label_y_startoffset, 300, 30);
        add(rightKeyLabel);

        // Buton pentru a schimba tasta
        changeRightKeyButton = new Menu_Buttons("Change Right Key",Boolean.FALSE);
        changeRightKeyButton.setBounds(ct.button_change_x_offset, ct.button_change_y_offset, 260, 30);
    ...
    // Eticheta + Buton pentru left_key
        ...
        leftKeyLabel.setBounds(ct.button_change_label_x_offset, ct.button_change_label_y_startoffset + ct.button_change_spacing, 300, 30);
        add(leftKeyLabel);

        //Buton pentru a schimba tasta LEFT
        changeLeftKeyButton = new Menu_Buttons("Change Left Key",Boolean.FALSE);
        changeLeftKeyButton.setBounds(ct.button_change_x_offset, ct.button_change_y_offset+ct.button_change_spacing, 260, 30);
    ...
    // Etichetă + Buton pentru JUMP
        ...
        jumpKeyLabel.setBounds(ct.button_change_label_x_offset, ct.button_change_label_y_startoffset + 2 * ct.button_change_spacing, 300, 30);
        add(jumpKeyLabel);

        //buton pentru a schimba tasta JUMP
        JButton changeJumpKeyButton = new Menu_Buttons("Change Jump Key",Boolean.FALSE);
        changeJumpKeyButton.setBounds(ct.button_change_x_offset, ct.button_change_y_offset + 2 * ct.button_change_spacing, 260, 30);
    ...
    // Etichetă + Buton pentru Change_Weapon
        ...
        changeWeaponKeyLabel.setBounds(ct.button_change_label_x_offset, ct.button_change_label_y_startoffset + 3 * ct.button_change_spacing, 300, 30);
        add(changeWeaponKeyLabel);

        JButton changeWeaponKeyButton = new Menu_Buttons("Change Weapon Key",Boolean.FALSE);
        changeWeaponKeyButton.setBounds(ct.button_change_x_offset, ct.button_change_y_offset + 3 * ct.button_change_spacing, 260, 30);
    ...
    // Etichetă + Buton pentru Reload_Weapon
        ...
        reloadWeaponKeyLabel.setBounds(ct.button_change_label_x_offset, ct.button_change_label_y_startoffset + 4 * ct.button_change_spacing, 300, 30);
        add(reloadWeaponKeyLabel);

        JButton reloadWeaponKeyButton = new Menu_Buttons("Change Reload Key",Boolean.FALSE);
        reloadWeaponKeyButton.setBounds(ct.button_change_x_offset, ct.button_change_y_offset + 4 * ct.button_change_spacing, 260, 30);
